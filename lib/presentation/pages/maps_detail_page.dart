...
class MapsDetailPage extends StatelessWidget {
  final Car car;
  const MapsDetailPage({required this.car, super.key});
          ...
          children: [
            FlutterMap(
              options: const MapOptions(
                initialCenter: LatLng(28.70405920, 77.10249020),
                initialZoom: 13,
              ),
              children: [
                TileLayer(
            ...
            // Example bottom card (replace with your carDetailsCard widget)
            Positioned(
              bottom: 0,
              left: 0,
              right: 0,
